...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread("/Users/ayaskant/PycharmProjects/Number_Plate_Recognition/Training_data/training_chars.png")            # read in training numbers image
    ...
    for npaContour in npaContours:                          # for each contour
        if cv2.contourArea(npaContour) > MIN_CONTOUR_AREA:          # if contour is big enough to consider
            ...
            cv2.imshow("Training_Characters.png", imgTrainingNumbers)      # show training numbers image, this will now have red rectangles drawn on it
    ...
    np.savetxt("/Users/ayaskant/PycharmProjects/Number_Plate_Recognition/Training_data/classifications.txt", npaClassifications)           # write flattened images to file
    np.savetxt("/Users/ayaskant/PycharmProjects/Number_Plate_Recognition/Training_data/flattened_images.txt", npaFlattenedImages)          #
